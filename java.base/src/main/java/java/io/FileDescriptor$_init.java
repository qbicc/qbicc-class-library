...
public class FileDescriptor$_init {
    // alias
    private int fd;
    private long handle;
        ...
        SharedSecrets.setJavaIOFileDescriptorAccess(
                new JavaIOFileDescriptorAccess() {
                    ...
                    public int get(FileDescriptor fdo) {
                        return ((FileDescriptor$_init)(Object)fdo).fd;
                    }

                    public void setAppend(FileDescriptor fdo, boolean append) {
                        ((FileDescriptor$_init)(Object)fdo).append = append;
                    }

                    public boolean getAppend(FileDescriptor fdo) {
                        return ((FileDescriptor$_init)(Object)fdo).append;
                    }
                    ...
                    public long getHandle(FileDescriptor fdo) {
                        return ((FileDescriptor$_init)(Object)fdo).handle;
                    }
                }
        );
    }
