...
@Tracking("src/java.base/unix/classes/sun/net/www/protocol/http/ntlm/NTLMAuthentication.java")
@Tracking("src/java.base/windows/classes/sun/net/www/protocol/http/ntlm/NTLMAuthentication.java")
public class NTLMAuthentication extends AuthenticationInfo {
    private static final long serialVersionUID = Build.Target.isUnix() ? 170L : 100L;
    ...
    static {
        if (Build.Target.isUnix()) {
            ...
            // TODO: Actually port the Windows implementation of this class.
    ...
    // TODO: The rest of this class is just the Unix code with no attempt to merge in the Windows logic
