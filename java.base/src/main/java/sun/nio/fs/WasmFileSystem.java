...
import static sun.nio.fs.WasmNativeDispatcher.*;

/**
 * Wasm implementation of FileSystem
 */

class WasmFileSystem extends BsdFileSystem {

    WasmFileSystem(UnixFileSystemProvider provider, String dir) {
        super(provider, dir);
    }
